...
void dialogOauthSetup::on_pushButtonAuthorizeOnTwitch_clicked()
{
    ...
    QString link = "https://api.twitch.tv/kraken/oauth2/authorize?response_type=token&client_id="+twitchclientid+"&redirect_uri=http://oauth.abyle.org/&scope=channel_editor+user_read+user_subscriptions+user_follows_edit+chat_login+channel_read";
